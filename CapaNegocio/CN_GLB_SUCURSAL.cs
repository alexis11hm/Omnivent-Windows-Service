...
namespace CapaNegocio
{
    public class CN_GLB_SUCURSAL
    {
        ...
        public async Task InsertarSucursalesAPI(List<VM_GLB_SUCURSAL> sucursales, string token)
        {
            try
            {
        ...
        public async Task ActualizarSucursalesAPI(List<VM_GLB_SUCURSAL> sucursales, string token)
        {
            try
            {
                //Creamos un clientHandler para la validacion de certificado
        ...
        public async Task EliminarSucursalesAPI(List<VM_GLB_SUCURSAL> sucursales, string token)
        {
            try
            {
                var contador = 0;

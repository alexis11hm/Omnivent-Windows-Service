...
namespace CapaNegocio
{
    public class CN_PDV_FLUJO_EFECTIVO
    {
        ...
        public async Task InsertarFlujosEfectivoAPI(List<VM_PDV_FLUJO_EFECTIVO> flujosEfectivo, string token)
        {
            try
            {
        ...
        public async Task ActualizarFlujosEfectivoAPI(List<VM_PDV_FLUJO_EFECTIVO> flujosEfectivo, string token)
        {
            try
            {
                //Creamos un clientHandler para la validacion de certificado
        ...
        public async Task EliminarFlujosEfectivoAPI(List<VM_PDV_FLUJO_EFECTIVO> flujosEfectivo, string token)
        {
            try
            {
                var contador = 0;

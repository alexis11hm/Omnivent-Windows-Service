...
namespace CapaNegocio
{
    public class CN_PDV_VENTA_DETALLE
    {
        ...
        public async Task<string> InsertarVentasDetalleAPI(List<VM_PDV_VENTA_DETALLE> ventasDetalle, string token)
        {
            try
            {
        ...
        public async Task<string> ActualizarVentasDetalleAPI(List<VM_PDV_VENTA_DETALLE> ventasDetalle, string token)
        {
            try
            {
                //Creamos un clientHandler para la validacion de certificado
        ...
        public async Task<string> EliminarVentasDetalleAPI(List<VM_PDV_VENTA_DETALLE> ventasDetalle, string token)
        {
            try
            {

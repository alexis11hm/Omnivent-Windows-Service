...
namespace CapaNegocio
{
    public class CN_PDV_ALMACEN_PRODUCTO
    {
        ...
        public async Task<string> InsertarAlmacenProductosAPI(List<VM_PDV_ALMACEN_PRODUCTO> almacenProductos, string token)
        {
            try
            {
        ...
        public async Task<string> ActualizarAlmacenProductosAPI(List<VM_PDV_ALMACEN_PRODUCTO> almacenProductos, string token)
        {
            try
            {
                //Creamos un clientHandler para la validacion de certificado
        ...
        public async Task<string> EliminarAlmacenProductosAPI(List<VM_PDV_ALMACEN_PRODUCTO> almacenProductos, string token)
        {
            try
            {
